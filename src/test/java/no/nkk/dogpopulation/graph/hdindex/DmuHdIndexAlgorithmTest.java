...
public class DmuHdIndexAlgorithmTest extends AbstractGraphTest {
    ...
    public void setup() {
        ...
        dataErrorFile = new File(hdIndexFolderPath, "errors.txt");
    }
    ...
    public void thatNonEmptyFilesAreProduced() throws IOException {
       ...
       Assert.assertTrue(dataErrorFile.isFile());
       Assert.assertTrue(dataErrorFile.length() == 0);
    }
    ...
    @Test
    public void thatDogsWithIncorrectGenderGetsEliminated() throws IOException {
        // given
        String breed1 = "Breed1";
        addBreed(breed1, "1");
        String breed2 = "Breed2";
        addBreed(breed2, "2");
        addDog("A", "NO/00777/95", "2008-02-26", DogGender.FEMALE, breed2, "A2", "2010-06-10");
        addDog("C", "NO/00777/93", "2005-07-11", DogGender.MALE, breed1, "B2", "2007-06-12");
        connectChildToMother("A", "C"); // male C cannot be mother
